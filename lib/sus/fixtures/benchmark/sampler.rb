...
module Sus
	module Fixtures
		module Benchmark
			class Sampler
				# Initializes a new Samples object with an optional minimum sample size.
				...
				# @parameter margin_of_error [Float] The acceptable margin of error relative to the mean (default: 0.01, e.g. ±2%).
